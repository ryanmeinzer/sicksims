...
<div>
    ...
    <div className='gameDirections'>
        ...
        <h6 className='mobile-only'><span className='emphasizedText'>Click</span> naive people<span role="img" aria-label="naive person emoji">🥴</span> to make them safe <span role="img" aria-label="safe person emoji">😷</span> before they become sick <span role="img" aria-label="sick person emoji">🤢</span> <br></br> <span className='emphasizedText'>Click</span> sick people <span role="img" aria-label="sick person emoji">🤢</span> to make them quarantined for recovery <span role="img" aria-label="quarantined person emoji">🤒</span> before they become terminal <span role="img" aria-label="terminal person emoji">😵</span></h6>
